...
export { CourseCard, CourseCard2, CourseOverviewSection, CourseCurriculumSection, CourseReviewSection, CourseInstructorSection, CourseFaqSection, CourseSidebarSection }