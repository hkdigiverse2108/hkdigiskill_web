...
const CategoriesSection = () => {
  ...
  return (
    ...
    ${colorClasses[index % colorClasses.length]}`}
                  ...
                  {/* <div className="eb-course-cat-container-grid eb-course-cat-grid edublink-row">
                    <div
                      className="edublink-col-lg-3 edublink-col-md-6 edublink-col-sm-6 edublink-course-single-cat edublink-course-cat-single-grid elementor-repeater-item-71e2b22"
                      data-aos="fade-up"
                    ...
                    <div
                      className="edublink-col-lg-3 edublink-col-md-6 edublink-col-sm-6 edublink-course-single-cat edublink-course-cat-single-grid "
                      data-aos="fade-up"
                    ...
                    <div
                      className="edublink-col-lg-3 edublink-col-md-6 edublink-col-sm-6 edublink-course-single-cat edublink-course-cat-single-grid elementor-repeater-item-29d920a"
                      data-aos="fade-up"
                    ...
                    <div
                      className="edublink-col-lg-3 edublink-col-md-6 edublink-col-sm-6 edublink-course-single-cat edublink-course-cat-single-grid elementor-repeater-item-b3ea4bf"
                      data-aos="fade-up"
