      ...
      <div className="elementor-container elementor-column-gap-extended">
        <div className="elementor-column elementor-col-50 elementor-top-column elementor-element elementor-element-4e1c3b2" data-id="4e1c3b2" data-element_type="column">
          <div className="elementor-widget-wrap elementor-element-populated">
            <div className="elementor-element elementor-element-8bf8804 edublink-br-tl-none animated elementor-widget elementor-widget-heading" data-aos="fade-up" data-aos-duration={1200}>
              <div className="elementor-widget-container">
                <h1 className="elementor-heading-title elementor-size-default">
                  The Best <br />
                  Program to <span className="edublink-color-secondary">Enroll</span> for Exchange
                </h1>{" "}
              </div>
            </div>
        ...
        <MouseParallax className="elementor-column elementor-col-50 elementor-top-column elementor-element elementor-element-4c05e46">
          <div className="elementor-widget-wrap elementor-element-populated">
            <section className="elementor-section elementor-inner-section elementor-element elementor-element-1fca101 elementor-section-boxed elementor-section-height-default elementor-section-height-default" data-id="1fca101" data-element_type="section">
              <div className="elementor-container elementor-column-gap-no">
                <div className="elementor-column elementor-col-50 elementor-inner-column elementor-element elementor-element-3949981" data-id={3949981} data-element_type="column">
                  <div className="elementor-widget-wrap elementor-element-populated">
                    <div className="elementor-element elementor-element-689a668 elementor-widget__width-auto elementor-absolute elementor-hidden-tablet_extra elementor-hidden-tablet elementor-hidden-mobile animated elementor-widget elementor-widget-edublink-animation">
                      <div className="elementor-widget-container">
                        <div className="edublink-animation-widget edublink-animation-display-type-mouse-track edublink-animation-content-type-image edublink-mouse-track-item">
                          <span data-depth={2}>
                            <img decoding="async" src={`${ImagePath}faq/shape-13.png`} alt="Hero Shape 5" />
                          </span>
                        </div>{" "}
                      </div>
                    </div>
                    <div className="elementor-element elementor-element-5df5061 elementor-widget__width-auto elementor-absolute elementor-hidden-mobile animated elementor-widget elementor-widget-html" data-aos="fade-right" data-aos-duration={1200}>
                      <div className="elementor-widget-container">
                    ...
                    <div className="elementor-element elementor-element-5744aa9 elementor-widget__width-auto elementor-absolute elementor-hidden-tablet_extra elementor-hidden-tablet elementor-hidden-mobile animated elementor-widget elementor-widget-edublink-animation">
                      <div className="elementor-widget-container">
                        <div className="edublink-animation-widget edublink-animation-display-type-mouse-track edublink-animation-content-type-image edublink-mouse-track-item">
                          <span data-depth={-2}>
                            <img decoding="async" src={`${ImagePath}cta/shape-04.png`} alt="Hero Shape 7" />
                          </span>
                        </div>{" "}
                      </div>
                    </div>
                    <div className="elementor-element elementor-element-1d3c287 animated elementor-widget elementor-widget-image" data-aos="fade-down" data-aos-duration={1500}>
                      <div className="elementor-widget-container">
                        <img decoding="async" width={270} height={300} src={`${ImagePath}banner/girl-2.webp`} className="attachment-full size-full wp-image-1269" />{" "}
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="elementor-widget-wrap elementor-element-populated">
                    <div className="elementor-element elementor-element-bf91029 elementor-widget__width-auto elementor-absolute elementor-hidden-tablet_extra elementor-hidden-tablet elementor-hidden-mobile animated elementor-widget elementor-widget-edublink-animation">
                      <div className="elementor-widget-container">
                        <div className="edublink-animation-widget edublink-animation-display-type-mouse-track edublink-animation-content-type-image edublink-mouse-track-item">
                          <span data-depth={-2}>
                            <img decoding="async" src={`${ImagePath}faq/shape-12.png`} alt="Hero Shape 6" />
                          </span>
                        </div>{" "}
                      </div>
                    </div>
                    <div className="elementor-element elementor-element-9353897 elementor-widget__width-auto elementor-absolute elementor-hidden-tablet_extra elementor-hidden-tablet elementor-hidden-mobile animated elementor-widget elementor-widget-edublink-animation">
                      <div className="elementor-widget-container">
                        <div className="edublink-animation-widget edublink-animation-display-type-mouse-track edublink-animation-content-type-image edublink-mouse-track-item">
                          <span data-depth={2}>
                            <img decoding="async" src={`${ImagePath}faq/shape-09.png`} alt="Hero Shape 10" />
                          </span>
                        </div>{" "}
                      </div>
                    </div>
                    <div className="elementor-element elementor-element-5b54169 animated elementor-widget elementor-widget-image" data-aos="fade-up" data-aos-duration={1500}>
                      <div className="elementor-widget-container">
                        <img loading="lazy" decoding="async" width={240} height={370} src={`${ImagePath}banner/man-1.webp`} className="attachment-full size-full wp-image-1268" alt="" />
                      </div>
                    </div>
                  </div>
                </div>
