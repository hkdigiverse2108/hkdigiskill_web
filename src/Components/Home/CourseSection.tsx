  ...
  return (
    <section className="elementor-section elementor-top-section elementor-element elementor-element-e0cd102 elementor-section-boxed elementor-section-height-default elementor-section-height-default">
      ...
      <div className="elementor-container elementor-column-gap-extended">
        <div className="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-cd4cbd1" data-id="cd4cbd1" data-element_type="column">
          <div className="elementor-widget-wrap elementor-element-populated">
            <div className="elementor-element elementor-element-b2d71ca elementor-widget elementor-widget-edublink-heading" data-aos="fade-up" data-aos-duration={1000}>
            ...
            <div className="elementor-element elementor-element-6bce914 distant-learning-course elementor-widget elementor-widget-edublink-lp-courses">
              <div className="elementor-widget-container">
                <div className="edublink-course-widget-wrapper">
                  <div className="edublink-archive-lp-courses edublink-course-archive edublink-lms-courses-grid active-white-bg edublink-row eb-masonry-grid-wrapper">
                    <div id="post-12817" className="edublink-course-style-1 edublink-course-1-grid-item edublink-col-lg-4 edublink-col-md-6 edublink-col-sm-6 eb-masonry-item post-12817 lp_course type-lp_course status-publish has-post-thumbnail hentry course_category-business course_category-digital-marketing course_tag-development course" data-aos="fade-up" data-aos-duration={1000}>
                    ...
                    <div id="post-12798" className="edublink-course-style-1 edublink-course-1-grid-item edublink-col-lg-4 edublink-col-md-6 edublink-col-sm-6 eb-masonry-item post-12798 lp_course type-lp_course status-publish has-post-thumbnail hentry course_category-motivation course_category-programming course_tag-development course" data-aos="fade-up" data-aos-duration={1200}>
                      <div className="edublink-single-course course-style-1">
                        <div className="inner">
                          <div className="thumbnail">
                            <Link className="course-thumb" to={""}>
                          ...
                          <div className="content">
                            ...
                            <div className="course-price">
                              <span className="course-item-price">
                                <span className="origin-price">$59</span>
                                <span className="price">$49</span>
                              </span>
                            </div>
                            <ul className="course-meta">
                              <li>
                                <i className="icon-24" />8 Lessons
                              </li>
                              <li>
                                <i className="icon-25" />
                                72 Students
                    ...
                    <div id="post-12782" className="edublink-course-style-1 edublink-course-1-grid-item edublink-col-lg-4 edublink-col-md-6 edublink-col-sm-6 eb-masonry-item post-12782 lp_course type-lp_course status-publish has-post-thumbnail hentry course_category-programming course_tag-development course" data-aos="fade-up" data-aos-duration={1400}>
                      <div className="edublink-single-course course-style-1">
                        <div className="inner">
                          <div className="thumbnail">
                            <Link className="course-thumb" to={""}>
